<script>
  ...
  import presets from "./presets_data";
  import ImagePreview from "./lib/ImagePreview.svelte";
  import DialogHeader from "./lib/DialogHeader.svelte";
...
<main>
  <div class="wraper">
    <header>
      <h1 class="title">CSS Image Editor</h1>
    </header>
    <div class="dialog">
      {#if $image}
        <svg
        ...
        <aside class="dialog-aside">
          <h3 class="aside-heading">Presets</h3>
          <div class="presets">
            {#each presets as pre, i}
              <Preset preset={pre} />
            {/each}
          </div>

          <h3 class="aside-heading">Filters</h3>
          <Filters />
        </aside>
